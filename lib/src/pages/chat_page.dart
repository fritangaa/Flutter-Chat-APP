...
import 'package:chat/src/widgets/custom_chat_message.dart';
...
class _ChatPageState extends State<ChatPage> with TickerProviderStateMixin {
              ...
              child: Platform.isIOS
                  ? CupertinoButton(
                      ...
                      onPressed: _escribiendo
                          ? () => _handleSumint(_textController.text.trim())
                          : null,
                    )
                  : Container(
                      margin: EdgeInsets.symmetric(horizontal: 4),
  ...
  void dispose() {
    ...
    //off instancia arreglo de mansajes
